...
class UnitProcess(WT3UnitProcess):
    def fixed_cap(self):  # flow in mgd for this cost curve
    ...
    def elect(self):
        return 0.00005 # An Analysis of Energy Consumption and the Use of Renewables for a Small Drinking Water Treatment Plant
