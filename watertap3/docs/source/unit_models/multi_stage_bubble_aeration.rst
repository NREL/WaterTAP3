.. _multi_stage_bubble_aeration_unit:
...
The ``electricity_flow`` column is read in from the ``epa_cost_curves.csv`` based on influent TDS
...
Multi-Stage Bubble Aeration Module
----------------------------------------
