...
base_fixed_cap_cost = .72557  # from IT3PR- tri media filtration cost curve, section 3.5.6 figure 3.3
cap_scaling_exp = .5862  # from IT3PR- tri media filtration cost curve, section 3.5.6 figure 3.3
...
train_constituent_removal_factors = generate_constituent_list.get_removal_factors("cartridge_filtration")
...
see property package for documentation.}"""))
    ...
    #build(up_name = "cartridge_filtration")
    
    def build(self):
        import unit_process_equations
        return unit_process_equations.build_up(self, up_name_test = "cartridge_filtration")
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None):
        ...
        def up_costing(self, cost_method="wt"):
            ...
            if cost_method == "wt":
                ...
                self.electricity = 0 # kwh/m3 (PML value)
