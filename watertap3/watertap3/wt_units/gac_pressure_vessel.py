...
module_name = 'gac_pressure_vessel'
basis_year = 2017
tpec_or_tic = 'TPEC'
...
class UnitProcess(WT3UnitProcess):
    ...
    def fixed_cap(self, unit_params):
        ...
        self.cost_coeffs, self.elect_coeffs, self.mats_name, self.mats_cost, _ = epa_cost_curve(module_name, ebct=self.ebct)
