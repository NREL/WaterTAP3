...
see property package for documentation.}"""))
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None, unit_params=None):
        ...
        #### CHEMS ###
        tds_in = 257000
        evap_rate = -0.00000113408 * tds_in + 1.5213 # m/y
        print(evap_rate)
        if evap_rate <= 0.5:
            a = 0.0601
            b = 0.706
        if evap_rate <= 1.0 and evap_rate > 0.5:
            a = 0.0310
            b = 0.761
        else:
            a = 0.0127
        ...
        def fixed_cap(flow_in):
            # evap_pond_cap = (1.6227 * flow_in + 0.1821) * (0.9179 * np.log(tds_in) - 10.442)
            evap_pond_cap = a * flow_in ** b
