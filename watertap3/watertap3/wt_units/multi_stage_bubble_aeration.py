...
class UnitProcess(WT3UnitProcess):
    ...
    def fixed_cap(self):
        ...
        :return: Fixed capital for multi-stage bubble aeration [$MM]
        '''
        ...
        msba_cap = self.cost_coeffs[0] * self.flow_in ** self.cost_coeffs[1]  # $
        return msba_cap * 1E-6  # M$

    def elect(self):
        '''
        Electricity intensity for multi-stage bubble aeration [kWh/m3]
        :return:
        '''
