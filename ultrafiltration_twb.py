...
#Project Cost for Filter = $2.5M x (flow in mgd)
...
nitrate_removal = 0 # None but in Excel tool appears to be removed sometimes?
TOrC_removal = 0.3 # Salveson et al, 2010
EEQ_removal = 0.3 # Salveson et al, 2010

# captial costs basis
#Project Cost for Filter = $2.5M x (flow in mgd) page 55)
base_fixed_cap_cost = 2.5 #from TWB -> THIS IS SOMEHOW DIFFERENT FROM EXCEL CALCS NOT SURE WHY (3.125)
...
def total_up_cost(m = None, G = None, flow_in = 0, cost_method = 'wt', 
                  deep_bed_denitrifying_filter = True): # ONLY NEEDS FLOW IN FOR NOW
