...
see property package for documentation.}"""))
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None, unit_params=None):
        ...
        cap_scaling_exp = 0.9196  # Carlsbad Treatment train VAR tab
        time = self.flowsheet().config.time.first()
        flow_in = pyunits.convert(self.flow_vol_in[time],
                                  to_units=pyunits.m ** 3 / pyunits.hr)  # m3 /hr
        ...
        def electricity(flow_in):
            ...
            # flow_in_m3hr = pyunits.convert(self.parent_block().flow_vol_in[time],
