...
base_fixed_cap_cost = .504  # from Voutchkov (2018) table 4.7
cap_scaling_exp = .9954  # from Voutchkov (2018) table 4.7
...
train_constituent_removal_factors = generate_constituent_list.get_removal_factors("well_field")
...
see property package for documentation.}"""))
    ...
    def build(self):
        ...
        return unit_process_equations.build_up(self, up_name_test = "well_field")
