...
base_fixed_cap_cost = 24348  # from TWB -> THIS IS SOMEHOW DIFFERENT FROM EXCEL CALCS NOT SURE WHY (3.125))

cap_scaling_exp = .8671  # from TWB

recovery_factor = 0.9999  ## ASSUMED AS 1.0 -> MUST BE WRONG -> CHECK

# Get constituent list and removal rates for this unit process
import generate_constituent_list
train_constituent_list = generate_constituent_list.run()
train_constituent_removal_factors = generate_constituent_list.get_removal_factors("water_pumping_station")
...
see property package for documentation.}"""))
    ...
    #build(up_name = "water_pumping_station")
    
    def build(self):
        import unit_process_equations
        return unit_process_equations.build_up(self, up_name_test = "water_pumping_station")
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None):
        ...
        def up_costing(self, cost_method="wt"):
            ...
            pump_station = "Raw Water" # TODO not a given
            ...
            def fixed_cap(flow_in):
                ...
                if pump_station == "Raw Water":
                    ...
                    cap_scaling_factor = .8671

                    return (24348 * flow_in ** cap_scaling_factor)/1000000 # * TPEC * TIC # $M
                    ...
                    cap_scaling_factor = .8657

                    return (40299 * flow_in ** cap_scaling_factor)/1000000 # * TPEC * TIC # $M


            def pumping_power(flow_in): # TODO   the excel watertap has power based on different heights, efficiencies, etc.
                pumping_power = .746 * (flow_in_mgd * 695.2) * life_height/(3960 * pump_efficiency * motor_efficiency)/ (flow_in * 158)
