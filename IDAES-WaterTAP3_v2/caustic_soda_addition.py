...
see property package for documentation.}"""))
	...
	def get_costing(self, module=financials, cost_method="wt", year=None, unit_params=None):
		...
		base_fixed_cap_cost = 2262.8
		cap_scaling_exp = 0.6195  # Carlsbad Treatment train VAR tab
		...
		ratio_in_solution = 0.5 * pyunits.dimensionless  #
		solution_density = 1540 * (pyunits.kg / pyunits.m ** 3)  # kg/m3
		...
		def fixed_cap(flow_in):
			...
			caustic_cap = (source_cost * tpec_tic * number_of_units) * 1E-6
			return caustic_cap
