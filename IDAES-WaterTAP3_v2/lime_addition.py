...
see property package for documentation.}"""))
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None, unit_params=None):
        ...
        base_fixed_cap_cost = 16972
        cap_scaling_exp = 0.5435  # Carlsbad Treatment train VAR tab
        ...
        chemical_dosage = pyunits.convert(unit_params["lime"] * (pyunits.mg / pyunits.liter), to_units=(pyunits.kg / pyunits.m ** 3))  # kg/m3 should be read from .csv
        ...
        def solution_vol_flow(flow_in):  # m3/hr
            ...
            soln_vol_flow = chemical_rate / solution_density # m3/day
        ...
        def fixed_cap(flow_in):
            soln_vol_flow, chemical_rate = solution_vol_flow(flow_in)
            source_cost = base_fixed_cap_cost * chemical_rate ** cap_scaling_exp
            lime_cap = (source_cost * tpec_tic * number_of_units) * 1E-6
            return lime_cap
