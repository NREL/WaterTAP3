...
train_constituent_removal_factors = generate_constituent_list.get_removal_factors("landfill")
...
see property package for documentation.}"""))
    ...
    def build(self):
        ...
        return unit_process_equations.build_up(self, up_name_test = "landfill")
