...
The ferric chloride solution flow `S` [gal/day] is used in a cost curve of the general form:
...
WaterTAP3 is:
    ...
    .. math::
        ...
        C_{ferric} = 34153 S ^ {0.319}
|
This cost is then multiplied by the number of units and the TPEC factor for the final FCI for the
chemical addition. These parameters were determined by fitting data from FIGURE 5.5.13 - FERRIC
CHLORIDE FEED 42% SOLUTION in McGivney & Kawamura (2008).
...
* The volumetric flow `S` [gal/min] of the chemical solution, which incorporates the solution
  density [kg/m3]:
    ...
    .. math::
        ...
        S = \frac{M_{ferric}}{\rho_{ferric} X_{ferric}}
|
...
Then the electricity intensity is calculated as [kWh/m3]:
    ...
    .. math::
        ...
        E_{ferric} = \frac{0.746 S h}{3960 \eta_{pump} \eta_{motor} Q_{in}}
|
Assumptions
------------------------

* Number of units = 2
* Solution density [kg/m3] = 1460
