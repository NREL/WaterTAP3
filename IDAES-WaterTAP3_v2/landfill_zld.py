...
base_fixed_cap_cost = 13.53  # from PML tab, for the kg/hr and not consistent with the usual flow rate cost curves TODO
...
see property package for documentation.}"""))
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None, unit_params=None):
        ...
        self.costing.fixed_cap_inv_unadjusted = Expression(expr=(total_flow_rate / capacity_basis) ** cap_scaling_exp, doc="Unadjusted fixed capital investment")  # $M
