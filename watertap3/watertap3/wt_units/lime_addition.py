...
class UnitProcess(WT3UnitProcess):
    ...
    def get_costing(self, unit_params=None, year=None):
        ...
        cap_scaling_exp = 0.5435

        chem_name = 'Lime_Suspension_CaOH_2'
        chemical_dosage = pyunits.convert(unit_params['lime'] * (pyunits.mg / pyunits.liter), to_units=(pyunits.kg / pyunits.m ** 3))  # kg/m3
        ...
        def solution_vol_flow(flow_in):  # m3/hr
            ...
            soln_vol_flow = chemical_rate / solution_density  # m3/hr
