...
ALUM FEED in McGivney & Kawamura (2008).
...
* The volumetric flow `S` [gal/min] of the chemical solution, which incorporates the solution
  density [kg/m3] and ratio of the chemical in the solution [v/v]:
    ...
    .. math::
        ...
        S = \frac{M_{alum}}{\rho_{alum} X_{alum}}
|
...
Then the electricity intensity is calculated as:
    ...
    .. math::
        ...
        E_{alum} = \frac{0.746 S h}{3960 \eta_{pump} \eta_{motor} Q_{in}}
|
