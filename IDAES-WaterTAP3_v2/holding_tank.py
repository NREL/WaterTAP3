...
see property package for documentation.}"""))
    ...
    #build(up_name = "holding_tank")
    
    def build(self):
        import unit_process_equations
        return unit_process_equations.build_up(self, up_name_test = "holding_tank")
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None):
        ...
        def up_costing(self, cost_method="wt"):
            ...
            average_storage_time = .083 # days
            additional_surge_cap = .2
            
            capacity_needed = (flow_in / (24 * average_storage_time)) * (1/(1 + additional_surge_cap))
          
            
            flow_in = capacity_needed
