...
base_fixed_cap_cost = .0403  # from VAR tab; Raw Data from McGivney Figure 5.5.35b
cap_scaling_exp = .8657  # from VAR tab; Raw Data from McGivney Figure 5.5.35b
...
see property package for documentation.}"""))
    ...
    #build(up_name = "municipal_drinking")
    
    def build(self):
        import unit_process_equations
        return unit_process_equations.build_up(self, up_name_test = "municipal_drinking")
        ...
        def up_costing(self, cost_method="wt"):
            ...
            if cost_method == "wt":
                ...
                self.fixed_cap_inv_unadjusted = Expression(
                    ...
                    doc="Unadjusted fixed capital investment") # $M self.base_fixed_cap_cost * flow_in ** self.cap_scaling_exp
