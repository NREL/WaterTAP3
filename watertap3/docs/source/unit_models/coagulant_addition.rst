...
The coagulant flow `S` [gal/day] is used in a cost curve of the general form:
...
* The volumetric flow `S` [gal/min] of the chemical solution, which incorporates the solution
  density [kg/m3]:
    ...
    .. math::
        ...
        S = \frac{M_{coag}}{\rho_{coag} X_{coag}}
|
...
Then the electricity intensity is calculated as [kWh/m3]:
    ...
    .. math::
        ...
        E_{coag} = \frac{0.746 S h}{3960 \eta_{pump} \eta_{motor} Q_{in}}
|
Assumptions
------------------------
...
.. autoclass:: watertap3.wt_units.coagulant_addition.UnitProcess
