        ...
        def up_costing(self, cost_method="wt"):
            ...
            def get_flow_out(flow_in): 
                flow_in_m3h = pyunits.convert(self.parent_block().flow_vol_in[time],
                                      to_units=pyunits.meter**3/pyunits.hour) # conversion from MGD to m3hr
                
                water_recovery = 1 - (ccalc/pmax) * tds
                flow_out = flow_in_m3h * water_recovery
                # flow_out = flow_in_m3h * self.water_recovery # TODO
