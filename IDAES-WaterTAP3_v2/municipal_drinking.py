...
## REFERENCE: Raw Data from McGivney Figure 5.5.35b
...
see property package for documentation.}"""))
    ...
    def get_costing(self, module=financials, cost_method="wt", year=None, unit_params = None):
        ...
        lift_height = 300 # ft
        self.base_fixed_cap_cost = .0403  
        self.cap_scaling_exp = .8657 
        ...
        # capital costs (unit: MM$)
        self.costing.fixed_cap_inv_unadjusted = Expression(
            expr= (self.base_fixed_cap_cost * flow_in ** self.cap_scaling_exp) * tpec_tic,
